...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$query = "SELECT * FROM product WHERE product_id='" . $_GET["code"] . "'";
		...
		$productByCode=$resultset;
			$itemArray = array($productByCode[0]["product_id"]=>array('name'=>$productByCode[0]["name"], 'product_id'=>$productByCode[0]["product_id"], 'brand_name'=>$productByCode[0]["brand_name"],'quantity'=>$_POST["quantity"], 'unit_price'=>$productByCode[0]["unit_price"]));
...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		?>
				...
				<td style="text-align:left;border-bottom:#F0F0F0 1px solid;"><?php echo $item["brand_name"]; ?></td> 
				<td style="text-align:right;border-bottom:#F0F0F0 1px solid;"><?php echo $item["quantity"]; ?></td>
				<td style="text-align:right;border-bottom:#F0F0F0 1px solid;"><?php echo "$".$item["unit_price"]; ?></td>
				
				 <td style="text-align:center;border-bottom:#F0F0F0 1px solid;"><a href="index.php?action=remove&code=<?php echo $item["product_id"]; ?>" class="btnRemoveAction">Remove Item</a></td>
				</tr>
				<?php
