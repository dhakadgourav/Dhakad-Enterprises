...
<br><br><br><br><br><br><br>
   <?php 
   $sql = "SELECT emp_id, name,gender, work_experience ,age, email_id FROM employee";
...
<table class="table table-hover table-active" style="margin-left:300px">
  ...
  ';
    ...
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><th>" . $row["emp_id"]."</th><th>" . $row["name"]. "</th><th>". $row["gender"]."</th><th>". $row["work_experience"]."</th><th>" . $row["age"]."</th><th>" . $row["email_id"]. "</th></tr>";
    }
