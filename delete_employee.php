...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["emp_id"]))){
        $emp_id_err = 'Please enter emp_id.';
    } else{
    ...
    if(empty($emp_id_err) && empty($name_err)){
...
<div class="span9" >
    ...
    <h1 class="well">Remove emp</h1>
    <p>Fill the required form to remove a emp.</p>
