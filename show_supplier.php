...
<br><br><br><br><br><br><br>
   <?php 
   $sql = "SELECT supplier_id, name, company_name,phone_no FROM supplier";
...
<table class="table table-hover table-active" style="margin-left:300px">
  ...
  ';
    ...
    while($row = mysqli_fetch_assoc($result)) {
        echo "<tr><th>" . $row["supplier_id"]."</th><th>" . $row["name"]. "</th><th>". $row["company_name"]."</th><th>" . $row["phone_no"]."</th></tr>";
    }
