...
// if(!(empty(trim( isset($_POST['number']) && $_POST['number']))) || !(empty(trim( isset($_POST['cat_id']) && $_POST['cat_id'])))){
// $sql = "update category set availability=availability+".$_POST['number']." where category_id=".$_POST['cat_id'];
//     //echo $sql;
  ...
  ';
    ...
    while($row = mysqli_fetch_assoc($result)) {
       // $id = $dow["categody_id"];
        //echo $id;
      //echo 'sdsf';
        echo "<tr><td>" . $row["category_id"]."</td><td>" . $row["name"]. "</td><td>" . $row["availability"]."</td>
  ...
  <div class="container">
    <div class="row">
      ...
      <div id="socialMedia" class="span3 pull-right">
        <h5>SOCIAL MEDIA </h5>
        <a href="#"><img widtr="40" height="40" src="themes/images/facebook.png" title="facebook" alt="facebook"/></a>
