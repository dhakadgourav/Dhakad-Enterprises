...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["product_id"]))){
        $product_id_err = 'Please enter product_id.';
    } else{
    ...
    if(empty($product_id_err) && empty($name_err)){
...
<div class="span9" >
    ...
    <h1 class="well">Remove Product</h1>
    <p>Fill the required form to remove a product.</p>
