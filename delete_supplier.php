...
$supplier_id = $name = "";
$supplier_id_err = $name_err = "";
 
// Processing form data when form is submitted
if($_SERVER["REQUEST_METHOD"] == "POST"){
 
    // Check if supplier_id is empty
    if(empty(trim($_POST["supplier_id"]))){
        $supplier_id_err = 'Please enter supplier_id.';
    } else{
    ...
    if(empty($supplier_id_err) && empty($name_err)){
...
<div class="span9" >
    ...
    <h1 class="well">Remove supplier</h1>
    <p>Fill the required form to remove a supplier.</p>
